...
def prim(g: Graph, start_node: int, end_node: int, visited: list[bool]) -> int:
    ...
    while neighbor:
        ...
        if visited[v - 1] == False:
            ...
            for next_node in g.path[v]:
                if next_node[1] == end_node:
                    return total_weight + next_node[0]
...
if __name__ == "__main__":
    ...
    print(prim(g, start, end, visited))
